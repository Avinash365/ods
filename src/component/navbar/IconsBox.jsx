...
// import { Dropdown } from "./Dropdown"; // assuming exported separately
...
//       {/* Group for hover */}
//       <div className="relative group mr-10 border-2 border-black">
//         <TiThMenu className="w-6 h-6 text-nav-text cursor-pointer" />

//         <div className=" absolute right-0 top-8 bg-white p-4 shadow z-50">
//           <Dropdown/>
//         </div>
//       </div>
//     </div>
